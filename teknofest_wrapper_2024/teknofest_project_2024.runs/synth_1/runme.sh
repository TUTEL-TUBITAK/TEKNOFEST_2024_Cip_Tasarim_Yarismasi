...
HD_PWD='C:/Users/fatih/teknofest_project_2024/teknofest_project_2024.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log teknofest_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source teknofest_wrapper.tcl
